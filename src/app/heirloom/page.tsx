...
export default function HeirloomPage() {
  return (
    <>
      <Head>
        <title>Heirloom Project | Khaled Momani</title>
        <meta name="description" content="Heirloom: A mental health companion app designed and developed by Khaled Momani and PRJCT Lazrus. Explore the process, impact, and design." />
        <meta property="og:title" content="Heirloom Project | Khaled Momani" />
        <meta property="og:description" content="Heirloom: A mental health companion app designed and developed by Khaled Momani and PRJCT Lazrus. Explore the process, impact, and design." />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://afungiclub.com/heirloom" />
        <meta property="og:image" content="/headshot-bw.webp" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="Heirloom Project | Khaled Momani" />
        <meta name="twitter:description" content="Heirloom: A mental health companion app designed and developed by Khaled Momani and PRJCT Lazrus. Explore the process, impact, and design." />
