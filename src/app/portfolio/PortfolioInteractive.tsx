...
I was tasked with creating the visual identity of the app. The initial design I was given was a series of basic buttons and logic to display various backend calculations. It was up to me to bring it to life and make it intuitive to the user's needs.`}
      ...
      <section className={styles.section}>
        ...
        <div className={styles.projectGrid}>
          <div className={styles.projectCard}>
            <div className={styles.iframeWrapper} onClick={() => trackPortfolioClick('UIUserResearch', 'photo')}>
          ...
          <div className={styles.projectCard}>
            <div className={styles.iframeWrapper} onClick={() => trackPortfolioClick('UIWireFramingCram', 'photo')}>
          ...
          <div className={styles.projectCard}>
            <div className={styles.iframeWrapper} onClick={() => trackPortfolioClick('UIPrototypingAndAnimation', 'photo')}>
      ...
      <section className={styles.section}>
        ...
        <div className={styles.projectGrid}>
          <div className={styles.projectCard}>
            <div className={styles.iframeWrapper} onClick={() => trackPortfolioClick('BrandingArea59', 'photo')}>
              <Image src="/ProjectThumbnails/1-BrandingArea59.webp" alt="Branding Project: Area 59 – Personalized brand identity design focused on client individuality, authenticity, and emotional connection. Custom branding strategy for small business, personal branding, and unique visual storytelling." className={styles.projectImage} width={400} height={300} />
            </div>
          </div>
          <div className={styles.projectCard}>
            <div className={styles.iframeWrapper} onClick={() => trackPortfolioClick('BrandingDevelopingGripNDrip', 'photo')}>
              <Image src="/ProjectThumbnails/2-BrandingDevelopingGripNDrip.webp" alt="Branding Project: Developing Grip N Drip – Brand development and growth for an existing business, enhancing brand recognition, marketing readiness, and visual identity. Strategic branding for business growth and market expansion." className={styles.projectImage} width={400} height={300} />
            </div>
          </div>
          <div className={styles.projectCard}>
            <div className={styles.iframeWrapper} onClick={() => trackPortfolioClick('BrandingSqueezyDawgs', 'photo')}>
      ...
      <section className={styles.section}>
        ...
        <div className={styles.projectGrid}>
          <div className={styles.projectCard}>
            <div className={styles.iframeWrapper} onClick={() => trackPortfolioClick('MarketingVochos', 'photo')}>
          ...
          <div className={styles.projectCard}>
            <div className={styles.iframeWrapper} onClick={() => trackPortfolioClick('MarketingTheCreationOfEarl', 'photo')}>
          ...
          <div className={styles.projectCard}>
            <div className={styles.iframeWrapper} onClick={() => trackPortfolioClick('MarketingPresentingMyArt', 'photo')}>
