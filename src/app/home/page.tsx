...
export default function HomePage() {
  return (
    <>
      <Head>
        <title>Khaled Momani | Designer & Developer</title>
        <meta name="description" content="Portfolio of Khaled Momani - UI/UX Designer, Developer, and Marketer based in San Antonio, TX. Explore projects, art, and more." />
        <meta property="og:title" content="Khaled Momani | Designer & Developer" />
        <meta property="og:description" content="Portfolio of Khaled Momani - UI/UX Designer, Developer, and Marketer based in San Antonio, TX. Explore projects, art, and more." />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://afungiclub.com/" />
        <meta property="og:image" content="/headshot-bw.webp" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="Khaled Momani | Designer & Developer" />
        <meta name="twitter:description" content="Portfolio of Khaled Momani - UI/UX Designer, Developer, and Marketer based in San Antonio, TX. Explore projects, art, and more." />
          ...
          <Banner title="I Made this UI" variant="home" className="parallaxBanner">
            <div className={styles.bannerProjectsRow}>
              <a href="https://www.behance.net/gallery/220356837/Project-Name" target="_blank" rel="noopener noreferrer" className={styles.bannerProjectCard}>
                <Image src="/ProjectThumbnails/2-UIWireFramingCram.webp" alt="UI Design Project 2 - Wireframing CRM by Khaled Momani, Designer, UI Designer, Software Developer, Marketing" className={styles.bannerProjectImage} width={220} height={165} />
              </a>
              <a href="https://www.behance.net/gallery/222677953/Project-Name" target="_blank" rel="noopener noreferrer" className={styles.bannerProjectCard}>
                <Image src="/ProjectThumbnails/3-UIPrototypingAndAnimation.webp" alt="UI Design Project 3 - Prototyping and Animation by Khaled Momani, Designer, UI Designer, Software Developer, Marketing" className={styles.bannerProjectImage} width={220} height={165} />
              </a>
            </div>
