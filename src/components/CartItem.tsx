  ...
  return (
    <div data-layer="CartItem" className={styles.Cartitem}>
      <div data-layer="Frame206" className={styles.Frame206}>
        <div data-layer="RemoveProduct" className={styles.Removeproduct}>
        ...
        <div data-layer="ProductName" className={styles.Productname}>
          <div data-layer="Product Name" className={styles.ProductName}>Product Name</div>
        </div>
      </div>
      <div data-layer="Frame38" className={styles.Frame38}>
        <div data-layer="QTYPriceRow" className={styles.Qtypricerow}>
          <div data-svg-wrapper data-layer="Minus" className={styles.Minus}>
          ...
          <div data-layer="QTY" className={styles.Qty}>
            ...
            <div className={styles.QtyValue}>##</div>
          </div>
          <div data-svg-wrapper data-layer="Plus" className={styles.Plus}>
          ...
          <div data-layer="ItemSubTotal" className={styles.Itemsubtotal}>
            <div className={styles.ItemsubtotalValue}>$$$$</div>
          </div>
        </div>
      </div>
    </div>
